                ...
                $.ajax({
                    ...
                    if (result) {
                        ...
                        for (var chars in result) {
                            table.row.add(['<a href="/characters/'+ result[chars].character_id +'/mining-ledger"><span class="id-to-name" data-id="' + result[chars].character_id + '">{{ trans('web::seat.unknown') }}</span></a>', (new Intl.NumberFormat('en-US').format(result[chars].mining_bill)),
